...
namespace DigitalFishing
{
    public class bdd
    {
        ...
        {
            server = "localhost";
            database = "digitalfishing_neuzillet";
            uid = "root";
            password = "root";
        ...
        {
            //Requête Insertion Magazine
            string query = "INSERT INTO Pigiste (NomPigiste, PrenomPigiste, AdressePigiste, CPPigiste,VillePigiste,MailPigiste,NumSecuPigiste,ContratCadrePigiste) VALUES('" + nomP + "','" + prenomP + "','" + adresseP + "','" + CPP + "','" + villeP + "','" + prenomP + "','" + numSecuP + "','" + ccP + "')";
            Console.WriteLine(query);
        ...
        {
            //Requête Insertion Magazine
            string query = "INSERT INTO Contrat (LettreAccordContrat,MontantBrutContrat,MontantNetContrat,EtatContrat,FactureContrat,AgessaContrat,NumPigiste,NumMagazine) VALUES('" + la + "','" + mttB + "','" + mttN + "'," + etat + "," + fact + "," + agessa + ",'" + lePigiste.Num + "','" + leMagazine.Num + "')";
            Console.WriteLine(query);
        ...
        {
            //Update Magazine
            string query = "UPDATE Contrat SET LettreAccordContrat='" + la + "', EtatContrat='" + etat + "', AgessaContrat=" + agessa + ", FactureContrat = " + fact + ", MontantBrutContrat='" + mttB + "', NumPigiste='" + NumPigiste + "', NumMagazine='" + NumMagazine + "' WHERE NumContrat=" + numC;
            Console.WriteLine(query);
            //Open connection
            if (bdd.OpenConnection() == true)
            {
        ...
        {
            //Select statement
            string query = "SELECT * FROM Contrat inner join Pigiste on Contrat.NumPigiste=Pigiste.NumPigiste inner join Magazine on Magazine.NumMagazine=Contrat.NumMagazine";
            ...
            if (bdd.OpenConnection() == true)
            {
                ...
                while (dataReader.Read())
                {
                    Contrat leContrat = new Contrat(Convert.ToInt16(dataReader["NumContrat"]), Convert.ToString(dataReader["LettreAccordContrat"]), Convert.ToDouble(dataReader["MontantBrutContrat"]), Convert.ToDouble(dataReader["MontantNetContrat"]), Convert.ToBoolean(dataReader["AgessaContrat"]), Convert.ToBoolean(dataReader["FactureContrat"]), Convert.ToInt16(dataReader["EtatContrat"]), new Pigiste(Convert.ToInt16(dataReader["NumPigiste"]), Convert.ToString(dataReader["NomPigiste"]), Convert.ToString(dataReader["PrenomPigiste"]), Convert.ToString(dataReader["AdressePigiste"]), Convert.ToString(dataReader["CPPigiste"]), Convert.ToString(dataReader["VillePigiste"]), Convert.ToString(dataReader["MailPigiste"]), Convert.ToString(dataReader["NumSecuPigiste"]), Convert.ToString(dataReader["ContratCadrePigiste"])), new Magazine(Convert.ToInt32(dataReader["NumMagazine"]), Convert.ToString(dataReader["DateBouclageMagazine"]), Convert.ToString(dataReader["DateSortieMagazine"]), Convert.ToString(dataReader["DatePaiementMagazine"]), Convert.ToInt32(dataReader["BudgetMagazine"])));
